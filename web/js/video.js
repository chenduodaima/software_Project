...
const videoModule = () => {
    ...
    // 修改视频信息
    const update_video = () => {
        axios.put("/video/" + video.value.video_id, video.value)
            .then(() => {
                alert("修改视频信息成功");
                window.location.reload();
            })
            .catch((error) => {
                console.error("修改视频信息失败", error);
            });
    };

    // 删除视频
    const delete_video = () => {
        axios.delete("/video/" + video.value.video_id)
            .then(() => {
                alert("删除视频成功");
    ...
    return { video, tags, get_video, update_video, delete_video, current_comment, 
...
const myapp = Vue.createApp({
    setup() {
        const { video, tags, get_video, update_video, delete_video, current_comment, 
